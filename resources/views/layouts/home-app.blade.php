...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h3 class="logo"><a href="#" style="text-decoration: none;">Invention Disclosure Tools</a></h3>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="{{ route('login') }}" class="btn-get-started scrollto">Sign In</a></li>
        </ul>
  ...
  <section id="hero">
    <div class="hero-container">
      <h3>Welcome to <strong>Disclosure Tools</strong></h3>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>Invention Disclosure Tools</h3>
            <p>
              A108 Adam Street <br>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>Invention Disclosure Tools</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
          ...
          Designed by <a href="https://example.com/">Koinon</a>
        </div>
      </div>
