...
<div class="card">
    <div class="card-body">
        <h4 class="card-title"><button onclick="history.back()" class="btn btn-success text-center">Go Back</button> Title: Invention Disclosure | Reference Number: ayu7687/t767/21</h4>
        <ul class="nav nav-tabs nav-tabs" id="pills-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="pills-action-tab" data-bs-toggle="pill" href="#pills-action" role="tab" aria-controls="pills-action" aria-selected="true">Action</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="pills-cited-tab" data-bs-toggle="pill" href="#pills-cited" role="tab" aria-controls="pills-cited" aria-selected="false">Prior Art/Cited Doc(s)</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" id="pills-document-tab" data-bs-toggle="pill" href="#pills-document" role="tab" aria-controls="pills-document" aria-selected="false">Document(s)</a>
            </li>
        </ul>
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade" id="pills-compensation" role="tabpanel" aria-labelledby="pills-compensation-tab">
                <div class="media">
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
