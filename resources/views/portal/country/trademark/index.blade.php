  ...
  <x-forms.country.trademark :users="$users" :countries="$countries" :paralegals="$paralegals" />
    ...
    <div class="card-body">
        ...
        <ul class="nav nav-tabs nav-tabs-success" id="pills-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link text active" id="pills-Actions-tab" data-bs-toggle="pill" href="#pills-Actions"
                   role="tab" aria-controls="pills-Actions" aria-selected="true"><b> Actions </b></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="pills-Related-tab" data-bs-toggle="pill" href="#pills-Related" role="tab"
                   aria-controls="pills-Related" aria-selected="false"><b> Trademark Picture </b></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="pills-Abstract-tab" data-bs-toggle="pill" href="#pills-Abstract" role="tab"
                   aria-controls="pills-Abstract" aria-selected="false"><b> Taxes </b></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="pills-Documents-tab" data-bs-toggle="pill" href="#pills-Documents" role="tab"
                   aria-controls="pills-Documents" aria-selected="false"><b> Invoices </b></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="pills-applicant-tab" data-bs-toggle="pill" href="#pills-applicant"
                   role="tab" aria-controls="pills-applicant" aria-selected="false"><b> Applicants </b></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="pills-Notes-tab" data-bs-toggle="pill" href="#pills-Notes" role="tab"
                   aria-controls="pills-Notes" aria-selected="false"><b>Case Notes</b></a>
            </li>
        </ul>
        ...
        <h4 class="card-title" style="display: none">Trademark Record's</h4>
        <div class="tab-content"  style="display: none" id="pills-tabContent">
