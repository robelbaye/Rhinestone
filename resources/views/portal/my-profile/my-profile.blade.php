                            ...
                            <div class="author-card pb-3">
                                ...
                                <div class="author-card-profile">
                                    ...
                                    <div class="author-card-details">
                                        <h5 class="author-card-name text-lg">{{ Auth::user()->name }}<span> {{ Auth::user()->lastname }}</span></h5><span class="author-card-position">Joined {{ Auth::user()->created_at }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="wizard">
                            ...
                            <form class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="account-ln" value="{{ Auth::user()->lastname }}" disabled="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="account-phone" value="{{ Auth::user()->phone }}" disabled="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
