            ...
            <div class="card">
                <div class="card-body row">
                    <form class="row card-body" id="design-form"
                        action="{{ route('design-crud.store') }}" method="POST">
                        @csrf
                                ...
                                <label class="col-sm-1 col-form-label text-right">Case No: </label>
                                    <div class="col-md-2">
                                        <input name="CaseNo" type="CaseNo" class="form-control"
                                            placeholder=" Cost No"
                                            value="{{ old('CaseNo') ?? ($designs->CaseNo ?? (app()->environment('local') ? '' : '')) }}" required>
                                    </div>
                                @error('CaseNo')
                                ...
                                <label class="col-sm-1 col-form-label text-right">Internal Title: </label>
                                    <div class="col-sm-5">
                                        <input name="InternalTitle" type="InternalTitle" class="form-control"
                                            ...
                                            value="{{ old('InternalTitle') ?? ($designs->InternalTitle ?? (app()->environment('local') ? '' : '')) }}"
                                            required>
                                        @error('InternalTitle')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                ...
                                <label class="col-sm-1 col-form-label text-right">Formal Title: </label>
                                    <div class="col-sm-5">
                                        <input name="FormalTitle" type="FormalTitle" class="form-control"
                                            ...
                                            value="{{ old('FormalTitle') ?? ($designs->FormalTitle ?? (app()->environment('local') ? '' : '')) }}"
                                            required>
                                        @error('FormalTitle')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                ...
                                <label class="col-sm-1 col-form-label text-right">Date: </label>
                                    <div class="col-md-2">
                                        <input name="PDate" type="date"
                                            ...
                                            placeholder=" 72"
                                            value="{{ old('PDate') ?? ((isset($sow->PDate) ? $sow->PDate->format('d-m-Y') : null) ?? (app()->environment('local') ? '' : '')) }}"
                                            required>
                                    </div>
                                @error('PDate')
                                    <div class="invalid-feedback">
                                ...
                                <label class="col-sm-1 col-form-label text-right">Date: </label>
                                    <div class="col-md-2">
                                        <input name="ADate" type="date"
                                            ...
                                            placeholder=" 72"
                                            value="{{ old('ADate') ?? ((isset($sow->ADate) ? $sow->ADate->format('d-m-Y') : null) ?? (app()->environment('local') ? '' : '')) }}"
                                            required>
                                    </div>
                                @error('ADate')
                                    <div class="invalid-feedback">
                                ...
                                <label class="col-sm-1 col-form-label text-right">Date: </label>
                                    <div class="col-md-2">
                                        <input name="RDate" type="date"
                                            ...
                                            placeholder=" 72"
                                            value="{{ old('RDate') ?? ((isset($sow->RDate) ? $sow->RDate->format('d-m-Y') : null) ?? (app()->environment('local') ? '' : '')) }}"
                                            required>
                                    </div>
                                @error('RDate')
                                    <div class="invalid-feedback">
                        ...
                        <div class="footer">
                            <div class="float-right">
                                <button form="design-form" type="submit" class="btn btn-primary text-center">
                                    Save Design
                                </button>
                            </div>
                        </div>
